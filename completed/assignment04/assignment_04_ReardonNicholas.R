...
setwd("C:/Users/Nick/Documents/School/Statistics/dsc520-master")
...
ggplot(data=california_df, aes(x=date, group=1)) +
  geom_line(aes(y = cases)) +
  geom_line(data=florida_df, aes(y = cases)) +
...
ggplot(data=california_df, aes(x=date, group=1)) +
  ...
  geom_line(data=florida_df, aes(y = cases), color="darkred")
